      ...
      <div className="mx-auto max-w-[1364px] px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="max-w-[607px]">
          ...
          <p className="text-[18px] font-normal leading-[1.5] text-[#666666] max-w-[590px] mb-6">
            ...
            <br/>
            Each order is thoughtfully curated with farm-fresh ingredients,
            responsibly sourced, and delivered with care. From the moment you
            choose your items to the moment they arrive at your door, we ensure
            freshness, precision, and a delightful experience throughout.
          </p>
          ...
          {/* SHOP NOW BUTTON */}
          <Link to="/" className="bg-[#16A34A] text-white px-8 py-3 rounded-full text-[16px] font-medium inline-flex items-center gap-2 hover:bg-[#12893F] transition">
            Shop Now
