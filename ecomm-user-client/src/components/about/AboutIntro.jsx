      ...
      <div className="mx-auto max-w-[1364px] px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="max-w-[607px]">
          ...
          <p className="text-[18px] font-normal leading-[1.5] text-[#666666] max-w-[590px]">
            We are committed to delivering fresh, organic, and sustainably
            sourced food straight from local farms to your home. Our mission
            is to support healthy living while nurturing a cleaner and greener
            environment.
          </p>
        </div>
