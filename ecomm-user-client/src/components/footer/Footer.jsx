...
import TermsContent from "../policyModal/TermsContent";
import PrivacyContent from "../policyModal/PrivacyContent";
      ...
      <footer className="w-full bg-gray-100 pt-10">
        ...
        <div className="px-24 pb-10 grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-700">
              <Link to="/help"><li className="hover:text-green-600 cursor-pointer">Contact</li></Link>
              <Link to="/help"><li className="hover:text-green-600 cursor-pointer">Faqs</li></Link>
              <li onClick={() => setIsTermsOpen(true)} className="hover:text-green-600 cursor-pointer">Terms & Condition</li>
              <li onClick={() => setIsPrivacyOpen(true)} className="hover:text-green-600 cursor-pointer">Privacy Policy</li>
            </ul>
          </div>
